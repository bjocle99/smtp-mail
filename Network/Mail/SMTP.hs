...
defaultSupported =
  Supported
    ...
    , supportedHashSignatures = supportedSignatureSchemes
...
defaultTlsSettings = Conn.TLSSettingsSimple False False False defaultSupported
...
plainTextPart body =
  Part
    ...
    DefaultDisposition
    []
    (PartContent $ TL.encodeUtf8 body)
